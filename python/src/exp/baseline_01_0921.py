...
# %%
fig, axes = plt.subplots(6, 2, figsize=(60, 40))
...
for i in range(6):
    for v in range(2):
        try:
            sns.histplot(data=df_train, x=column[count], ax=axes[i][v])
            count += 1
...
# %%
df_train[["TP", "disease"]].corr()

# %%

df_train[["Alb", "disease"]].corr()

# %%
df_train.drop("Gender", axis=1).corr()
# %%

# データセット作成
# =================================================
set_file = df_train
x_train = set_file[["Age", "TP"]]
