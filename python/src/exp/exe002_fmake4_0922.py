...
df_train["D_div_T_ex2"] = (df_train["D_Bil"] / df_train["T_Bil"])

# 特徴量2:AST/ALT比（De Ritis比 # 6/5
df_train["AST_div_ALT_ex2"] = (df_train["AST_GOT"] / df_train["ALT_GPT"])

# 特徴量3:.フェリチン/AST比 フェリチンの代わりにタンパク質 7/6
df_train["TP_div_AST_ex2"] = (df_train["TP"] / df_train["AST_GOT"])

# 特徴量4:.グロブリン  1/(8*9)
df_train["Globulin_ex2"] = np.reciprocal(df_train["Alb"] / df_train["AG_ratio"])
...
#%%
# 特徴量1:直接ビリルビン/総ビリルビン比（D/T比） 3/2
df_test["D_div_T_ex2"] = (df_test["D_Bil"] / df_test["T_Bil"])

# 特徴量2:AST/ALT比（De Ritis比 # 6/5
df_test["AST_div_ALT_ex2"] = (df_test["AST_GOT"] / df_test["ALT_GPT"])

# 特徴量3:.フェリチン/AST比 フェリチンの代わりにタンパク質 7/6
df_test["TP_div_AST_ex2"] = (df_test["TP"] / df_test["AST_GOT"])

# 特徴量4:.グロブリン  1/(8*9)
df_test["Globulin_ex2"] = np.reciprocal(df_test["Alb"] / df_test["AG_ratio"])
