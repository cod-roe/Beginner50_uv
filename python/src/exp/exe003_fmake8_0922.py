...
# =================================================
# ベースライン作成：特徴量作成 追加
# ビリルビン/酵素比　総ビリルビン / ALT または 総ビリルビン / AST 2/5 2/6
# 総ビリルビン/ALP比  2/4
# アルブミン/ALT比 8/5
# 総タンパク/ALT比 7/5
# ALP/AST比またはALP/ALT比 4/6 4/5
# 総ビリルビン / アルブミン 2/8
...
df_train["TB_div_ALT_ex3"] = df_train["T_Bil"] / df_train["ALT_GPT"]
df_train["TB_div_AST_ex3"] = df_train["T_Bil"] / df_train["AST_GOT"]
...
# 特徴量4:総タンパク/ALT比 7/5
df_train["TP_div_ALT_ex3"] = df_train["TP"] / df_train["ALT_GPT"]


# 特徴量5:ALP/AST比またはALP/ALT比 4/6 4/5
df_train["ALP_div_AST_ex3"] = df_train["ALP"] / df_train["AST_GOT"]
df_train["ALP_div_ALT_ex3"] = df_train["ALP"] / df_train["ALT_GPT"]


# 特徴量6:総ビリルビン / アルブミン 2/8
df_train["TB_div_Alb_ex3"] = df_train["T_Bil"] / df_train["Alb"]
...
# 特徴量作成 説明変数同士の比率その２
# 特徴量1:ビリルビン/酵素比　総ビリルビン / ALT または 総ビリルビン / AST 2/5 2/6
df_test["TB_div_ALT_ex3"] = df_test["T_Bil"] / df_test["ALT_GPT"]
df_test["TB_div_AST_ex3"] = df_test["T_Bil"] / df_test["AST_GOT"]


# 特徴量2: 総ビリルビン/ALP比  2/4
df_test["TB_div_ALP_ex3"] = df_test["T_Bil"] / df_test["ALP"]

# 特徴量3:アルブミン/ALT比 8/5
df_test["Alb_div_ALT_ex3"] = df_test["Alb"] / df_test["ALT_GPT"]

# 特徴量4:総タンパク/ALT比 7/5
df_test["TP_div_ALT_ex3"] = df_test["TP"] / df_test["ALT_GPT"]


# 特徴量5:ALP/AST比またはALP/ALT比 4/6 4/5
df_test["ALP_div_AST_ex3"] = df_test["ALP"] / df_test["AST_GOT"]
df_test["ALP_div_ALT_ex3"] = df_test["ALP"] / df_test["ALT_GPT"]


# 特徴量6:総ビリルビン / アルブミン 2/8
df_test["TB_div_Alb_ex3"] = df_test["T_Bil"] / df_test["Alb"]
